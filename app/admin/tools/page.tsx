...
const TEMPLATES = [
  ...
  { key: 'partner_welcome',  label: '7 · Partner welcome — cabinet activated',   desc: 'Sent when a user registers as a partner. Carries the partner ID/slug, the partner page URL (partners.fractera.ai/<slug>), the widget iframe snippet, and the "choosing an affiliate program" guidance (Hostinger easiest; Contabo/GoDaddy via cj.com).' },
] as const
