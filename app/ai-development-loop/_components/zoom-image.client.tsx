...
// Click the image to open it full-screen in a modal. Close with the × button, a
// click on the dark backdrop, or Escape. Used for the development-loop diagram.
// A route-local copy of the same component on /ai-workspace-architect, kept here
// so this reference route stays self-contained.
