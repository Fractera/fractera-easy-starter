...
export const en: NewsArticleBase = {
  ...
  blocks: [
    ...
    { kind: 'callout', title: 'Editable by conversation.', text: 'Ask your workspace to list every section you have, put one in the top menu, reorder it in a drawer, change which role may see it, switch its languages, or even change its URL — and it does so by precise file edits, never by generating code. The same result from any AI model, as always.' },
