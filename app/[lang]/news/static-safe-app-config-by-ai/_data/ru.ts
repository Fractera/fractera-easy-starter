...
export const ru: NewsArticleOverride = {
  ...
  blocks: [
    ...
    {
      kind: 'h2',
      text: 'Метаданные в агентной инженерии: SEO-фундамент, который все откладывают на потом',
    },
    {
      kind: 'p',
    ...
    {
      kind: 'h3',
      text: 'Что входит в метаданные Next-приложения',
    },
    {
      kind: 'p',
    ...
    {
      kind: 'h3',
      text: 'Почему стандартный путь метаданных Next оставляет ИИ-агента с граблями',
    },
    {
      kind: 'p',
    ...
    {
      kind: 'h2',
      text: 'Ночь на €90 000: когда статический сайт незаметно становится динамическим',
    },
    {
      kind: 'p',
    ...
    {
      kind: 'h3',
      text: 'Что на самом деле значит «динамический рендеринг» для самостоятельного сервера',
    },
    {
      kind: 'p',
    ...
    {
      kind: 'h3',
      text: 'Одна строка, которая переводит всё Next-приложение в динамический рендеринг',
    },
    {
      kind: 'p',
    ...
    {
      kind: 'h3',
      text: 'Почему ИИ-агент в агентной инженерии особенно к этому склонен',
    },
    {
      kind: 'p',
    ...
    {
      kind: 'h2',
      text: 'Почему откладывать метаданные — ловушка для любого проекта агентной инженерии',
    },
    {
      kind: 'p',
    ...
    {
      kind: 'h2',
      text: 'Решение, часть первая: настройки руками на платформе для агентной инженерии',
    },
    {
      kind: 'p',
    ...
    },
    {
      ...
      alt: 'Панель App Settings в админке Fractera: поля имени бренда, короткого имени и описания слева, а справа — живой предпросмотр приложения, отрисованный под именем AIFA.',
      caption: 'App Settings в живой админке: слева вписываешь имя бренда, короткое имя и описание — справа предпросмотр обновляется сразу; здесь приложение переименовано в AIFA. Сохранено на сервере, видно на следующей загрузке, без пересборки.',
    },
    {
      kind: 'p',
    ...
    {
      kind: 'h2',
      text: 'Что именно можно настроить: полная карта настроек приложения',
    },
    {
      kind: 'p',
    ...
    {
      kind: 'h2',
      text: 'Решение, часть вторая: настройки приложения через ИИ-агента',
    },
    {
      kind: 'p',
    ...
    {
      kind: 'h2',
      text: 'Как платформа для агентной инженерии держит твоё приложение статическим',
    },
    {
      kind: 'p',
