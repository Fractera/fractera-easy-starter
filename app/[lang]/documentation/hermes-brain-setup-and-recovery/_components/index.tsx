...
// Entry for this documentation page (format: 'document'). Bilingual: resolve(lang)
// merges the en base with the full ru override; chrome (breadcrumb/back/title/min-read)
// is localized via getDocUi.
