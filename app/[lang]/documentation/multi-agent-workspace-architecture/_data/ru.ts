...
export const ru: DocBase = {
  ...
  faq: [
    ...
    },
    {
      ...
      a: 'На вашем собственном VPS или локальной машине. Это open-source self-hosted платформа на Next.js со встроенными локальной базой данных и объектным хранилищем; ваши данные и код остаются на вашем сервере.',
    },
    {
