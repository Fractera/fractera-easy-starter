...
export const ru: DocOverride = {
  title: 'Автоматизация конфигурации в агентной инженерии: настройки проекта голосом агента',
  description:
  ...
  blocks: [
    {
      kind: 'founder',
      text: 'Суть на одном дыхании: рабочее пространство, где ИИ пишет твоё приложение, должно позволять ИИ перенастраивать и само приложение. Поменять название сайта, описание, SEO или языки — это не поход по админ-панели, это одна фраза. Поэтому мы взяли панель настроек, сделанную для людей, и дали ИИ собственную дверь в неё. Тот же ассистент, что выпускает твои фичи, теперь по просьбе меняет облик сайта — и изменение живо уже на следующей загрузке, без пересборки.',
    },
    {
      kind: 'p',
    ...
    },
    {
      ...
      cite: 'Рома Армстронг, основатель Fractera',
    },
  ],
}
