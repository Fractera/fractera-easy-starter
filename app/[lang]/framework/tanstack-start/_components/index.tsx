...
// Entry for /framework/tanstack-start — STANDARD co-located page (CONTENT-I18N-ARCHITECTURE-
// STANDARD §7.6/§7.8): thin page.tsx + this entry + own ../_data. Calls
...
const FW = { id: 'tanstack-start' as const, name: 'TanStack Start' }
