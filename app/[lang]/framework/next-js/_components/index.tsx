...
// Entry for /framework/next-js — STANDARD co-located page (CONTENT-I18N-ARCHITECTURE-
// STANDARD §7.6/§7.8): thin page.tsx + this entry + own ../_data. It calls
// createContentPage DIRECTLY (the same path as /deployments/vps), NOT the shared
// createFrameworkPage factory. A plain framework page (no aircraft-carrier demo —
// that is Fractera-Pro-specific). Sections in the open slot, in order:
//   1. PricingFlow          — universal deploy form, page-aware (Next.js preselect)
//   2. FrameworkFeedbackCta  — framework-expert feedback card → Resend
//   3. founder quote        — Roma Armstrong (PostBody founder block)
// Hero = top-of-page deploy CTA (#pricing).

const FW = { id: 'next' as const, name: 'Next.js' }
