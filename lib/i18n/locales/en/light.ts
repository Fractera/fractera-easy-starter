...
export const light: LightContent = {
  ...
  installForm: {
    ...
    ipPlaceholder: 'Server IP address',
    loginPlaceholder: 'Login (default: root)',
    passwordPlaceholder: 'SSH password',
    checking: 'Checking server…',
    alreadyInstalled: 'Fractera Light is already installed on this server',
    currentSite: 'Current site',
    reinstallWarning: 'Re-deploying will permanently ERASE all data on this server (database, media, settings) and install a fresh copy. This cannot be undone.',
    reinstallConfirm: 'I understand this will permanently erase all existing data on the server',
    reinstallCta: 'Erase & redeploy',
    cantReach: "Can't reach the server. Check your IP and credentials.",
    retry: 'Retry',
    loadingAccount: 'Loading account info…',
    updatesTo: 'Updates will be sent to',
    emailConfirm: 'I confirm this email is correct and I want to receive deployment updates',
    checkServer: 'Check server',
    deployCta: 'Deploy Fractera Light',
    credentials: 'Ubuntu 22.04 / 24.04 · root access required · ~10 min install',
    installFailed: 'Installation failed',
    preparing: 'Preparing…',
    silentWarning: 'No updates for {secs}s — the step may be running a long operation.',
    errorDetails: 'Error details',
    tryAgain: 'Try again',
    mcpRetry: 'launch deployment via an AI agent (MCP)',
    progressToast: {
