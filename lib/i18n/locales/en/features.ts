...
export const features: FeaturesPart = {
  ...
  featureList: [
    { title: 'Voice AI Commands',     description: 'Issue coding commands and navigate content hands-free via microphone. AI agents respond to natural voice input in real time.',             badge: 'For all users' },
    ...
    { title: 'Skills Marketplace',    description: 'Discover, buy, and sell AI workflows in the community library. Share free skills or monetise your own automation recipes.',                badge: 'For all users' },
    ...
    { title: 'Hermes AI Agents',      description: 'Fully configured agents with self-learning memory. The most powerful AI technology available in seconds — not hours of setup.',           badge: 'For VIP sponsors', vip: true },
