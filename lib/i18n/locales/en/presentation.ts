...
export const presentation: PresentationPart = {
  dpHeader: {
    ...
    h2: 'Production-Grade RAG Architecture: Hermes & LightRAG Integration',
    description:
  ...
  dpLeft: {
    ...
    description:
      'Open a tab, speak your intent, watch code appear. No IDE, no local setup. Five coding platforms run directly in your browser — terminals included.',
  },
  ...
  platformsHeader: {
    label: 'AI Platforms',
    h2: 'The Core AI Engine: Five Agent Platforms, One Environment',
    description:
  ...
  platformCards: [
    ...
    { title: 'Gemini CLI',  subtitle: 'Long-context coding agent. Understands your entire project structure in one prompt.',                      company: 'Google'    },
    ...
    { title: 'LightRAG',    subtitle: 'Your company brain. Persistent vector memory shared across all five coding platforms.',                    company: 'Fractera'  },
  ],
}
