...
export const faqItems: FaqItem[] = [
  ...
  }, */
  {
    ...
    a: [
      'Да — партнёрская программа Fractera. Модель проста: VPS-рефералы.',
      'Получите партнёрскую ссылку у любого из четырёх VPS-провайдеров (Contabo, Hetzner, Netcup, DigitalOcean) и передайте её через страницу партнёров. Мы разместим её в блоке рекомендованных серверов на лендинге. Когда пользователь перейдёт по ссылке и купит сервер — провайдер выплатит вознаграждение напрямую вам. Fractera в транзакции не участвует.',
    ],
    trail: [
      'Чтобы присоединиться, зарегистрируйтесь на странице партнёров. Вы получите инструкции по передаче ваших VPS-партнёрских ссылок.',
  ...
  },
  {
    ...
    a: [
      'Ваш доход от сотрудничества проще и ближе, чем кажется. Пять минут настройки — и пассивные выплаты, пока ваш контент привлекает зрителей.',
    ],
    steps: [
      'Зарегистрируйтесь как аффилиат у одного — или у всех четырёх — наших проверенных VPS-провайдеров: Contabo, Hetzner, Netcup, DigitalOcean. Несколько минут на каждого.',
      'Откройте вкладку «Партнёрская программа» на странице партнёров, создайте партнёрский кабинет и загрузите ваши ссылки.',
      'Вы получите персональную ссылку на ко-брендированную версию сайта Fractera.',
      'Рекомендуйте Fractera в блоге, YouTube-канале, постах в соцсетях — везде, где собираются разработчики.',
      'Любой посетитель по вашей ссылке, который захочет попробовать Fractera, должен сначала купить VPS у хостинг-провайдера.',
      'Когда он нажимает «Купить сервер», провайдер фиксирует вашу реферальную ссылку и выплачивает вознаграждение напрямую вам — Fractera в этой транзакции не участвует.',
    ],
    trail: [
      'Математика простая: пять минут настройки — и пассивные выплаты, пока статья, пост или видео приносят трафик. VPS-провайдеры жёстко конкурируют за новых клиентов — и вознаграждают вас за каждого, кого вы приводите в их экосистему.',
    ],
  },
