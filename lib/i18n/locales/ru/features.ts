...
export const features: FeaturesPart = {
  ...
  featureList: [
    ...
    { title: 'Голосовые команды AI',       description: 'Отдавайте команды и навигируйте контент голосом. Агенты отвечают на естественный ввод в реальном времени.',                  badge: 'Для всех' },
    ...
    { title: 'Skills Marketplace',         description: 'Покупайте и продавайте воркфлоу-автоматизации в библиотеке сообщества. Делитесь навыками или монетизируйте рецепты автоматизации.',           badge: 'Для всех' },
  ...
  promoSection: {
    h2: 'Своя white-label платформа AI-агентов на Open Code',
    description:
      'Fractera — Open Code (исходники открыты). Форкните репозиторий, разверните собственный инстанс и создавайте продукты с ИИ — для себя или как бизнес: деплой серверов для клиентов и консалтинговые услуги.',
