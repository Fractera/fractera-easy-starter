...
export const install: InstallPart = {
  ...
  installForm: {
    ...
    progressToast: {
      ...
      dnsIntro: 'У регистратора добавьте две A-записи, указывающие на IP вашего сервера:',
      dnsCovers: 'Запись * покрывает все субдомены — admin.<ваш-домен>, auth.<ваш-домен> и так далее.',
    },
    successToast: {
