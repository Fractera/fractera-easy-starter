        ...
        {visible.map((name) => (
          <li key={name}>
            ...
            >
              <span
                aria-hidden
                className="flex h-6 w-6 shrink-0 items-center justify-center rounded-md border border-white/15 bg-white/[0.04] text-[11px] font-bold text-violet-300 group-hover:border-violet-500/40 transition-colors"
              >
                {name.charAt(0)}
              </span>
