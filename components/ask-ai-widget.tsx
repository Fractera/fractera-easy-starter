...
export function AskAiWidget({ lang }: { lang: string }) {
  ...
  return (
    <a
      ...
      aria-label={t.bubble}
      className="cta-shimmer group fixed right-5 z-50 inline-flex items-center overflow-hidden rounded-full bg-violet-600 hover:bg-violet-500 text-on-accent shadow-lg transition-colors"
