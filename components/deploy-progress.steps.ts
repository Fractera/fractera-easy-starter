...
export const ALL_STEPS: Step[] = [
  ...
  { id: 'geo_osrm',             label: 'Geo routing (OSRM)',                       done: false },
  { id: 'geo_nominatim',        label: 'Geo geocoding (Nominatim)',                done: false },
  { id: 'start_geo',            label: 'Geo service (maps/routing)',               done: false },
