...
const LS_TOKEN = 'fractera_partner_light_token'
const LS_STATE = 'fractera_partner_light_state'
const LS_EMAIL = 'fractera_partner_light_email'
const LS_SESSION_ID = 'fractera_partner_light_session_id'
const LS_IP = 'fractera_partner_light_ip'
const LS_HOSTING_CLICKED = 'fractera_partner_light_hosting_clicked'
...
export function PartnerPageFlowLight({ partner, lang }: { partner: PartnerData; lang: Lang }) {
  ...
  async function handleSubmitEmail(e: React.FormEvent) {
    ...
    try {
      ...
      const signInResult = await signIn('resend', {
        email: trimmed,
        callbackUrl: `${origin}/${lang}/light/${partner.slug}`,
        redirect: false,
      })
