            ...
            <div className="flex items-center gap-2">
              ...
              <div className="relative">
                ...
                >
                  ...
                  <span className="text-sm text-gray-400 max-w-[140px] truncate hidden sm:block">
                ...
                {menuOpen && (
                  <>
                    ...
                    <div className="absolute right-0 top-full mt-1 z-50 w-52 bg-neutral-900 border border-white/10 rounded-xl shadow-2xl p-1 flex flex-col">
              ...
              <button
                ...
                className="text-sm font-medium text-white bg-white/[0.06] hover:bg-white/[0.10] border border-white/10 hover:border-white/20 px-4 py-1.5 rounded-lg transition-colors"
              >
                Dashboard
              </button>
            </div>
