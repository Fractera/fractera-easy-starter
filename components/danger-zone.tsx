      ...
      {open && (
        <div className="flex flex-col gap-4 bg-red-500/[0.06] border border-red-500/40 rounded-xl p-5">
          ...
          <button
            ...
            className="w-full bg-red-600 hover:bg-red-700 text-on-accent text-sm font-semibold px-5 py-3 rounded-xl transition-colors disabled:opacity-30 disabled:cursor-not-allowed"
          >
